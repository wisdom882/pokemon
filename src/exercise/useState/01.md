...
- [Resource - React Hooks (UseState)](https://reactjs.org/docs/hooks-state.html)

## Exercise

In this exercise, we will create a form where you can type in your name and it will give
you a greeting as you type. Code out the `Greeting` component so that it manages
the state of the name and shows the greeting as the name is changed. If input is empty
display 'Please type your name' else display 'Hello' + input value. 
